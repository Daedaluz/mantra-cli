...
const file_service_platform_admin_proto_rawDesc = "" +
	...
	"\x10ListAdminClients\x12,.se.mantra.api.admin.ListAdminClientsRequest\x1a-.se.mantra.api.admin.ListAdminClientsResponseB+Z)github.com/daedaluz/mantra/lib/grpc/adminb\x06proto3"
